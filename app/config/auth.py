...
class AuthenticationConfig(BaseModel):
    ...
    RESET_PASSWORD_TOKEN_SECRET: SecretStr = SecretStr("secret")
    VERIFICATION_TOKEN_SECRET: SecretStr = SecretStr("secret")
    ADMIN_PANEL_SECRET_KEY: SecretStr = SecretStr("secret")
