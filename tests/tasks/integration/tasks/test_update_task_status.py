...
class TestUpdateTaskStatus(GetUrlMixin):
    ...
    async def test_update_task_status(
        ...
        update_dict = {"task_status": TaskStatus.IN_PROGRESS}
        ...
        assert updated_task.status == update_dict["task_status"]

    async def test_update_task_status_unauthenticated(
    ...
    async def test_update_task_status_inactive(
        self,
        async_client,
        create_user,
        create_team,
    ...
    async def test_update_task_status_task_not_exists(
    ...
    async def test_update_task_status_user_not_a_member_of_team(
        self,
        async_client,
        session,
        create_user,
    ...
    async def test_update_task_status_user_not_assigned_to_task(
        self,
        async_client,
        create_user,
        create_team,
